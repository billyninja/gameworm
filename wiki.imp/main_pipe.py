...
def open_article_to_tty(final_title, outcome, did_redir, uat, hits):
    ao_tty_colors = {
    ...
    msg = ao_tty_colors[outcome](final_title + " - " + ao_display, bold=True)
...
if __name__ == "main":
    ...
    for title in titles:
        ...
        open_article_to_tty(out, did_redir, uat, hits)
