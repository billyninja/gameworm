...
PLATFORM_ALIASES = {
    "ARC": ["Arcade", "Arcade game", "arcade", "CP System II", "Taito Type X", "Sega Mega-Tech", "Mega-Tech",
            "Sega X Board", "X Board", "Arcade version", "Neo Geo MVS"],
    ...
    "GC": ["GC", "NGC", "GameCube", "Gamecube", "Nintendo GameCube", "GCN"],
    ...
    "WII U": ["Wii U", "Nintendo Wii U", "Wii U Virtual Console", "Wii U VC"],
    ...
    "PS4": ["PS4", "PlayStation 4", "PlayStation 4 (PSN)", "PlayStation Network", "PlayStation Store",
            "PSOne Classic"],
    ...
    # APPLE
    "APL2": ["Apple", "Apple II", "Apple IIGS", "Apple IIgs"],
    "MAC": ["Macintosh", "Mac", "MAC", "Classic Mac OS", "Mac OS", "MacOS", "macOS", "OSX",
            "OS X", "Mac App Store", "Mac OS X", "Mac OS 9", "Macintosh Computer"],
    "IOS": ["iPhone", "iPhone OS", "iPhone / iPod Touch", "iPad", "iPod Touch, iPhone", "iPhone", "iOS",
            "Apple App store", "App Store", "iPod", "iPod Touch"],
    ...
    "AND": ["Android", "Google Play", "Android Market", "Kindle Fire", "Amazon App Store", "Nvidia Shield",
            "PlayStation Mobile"],
    "WEB": ["Web", "Flash", "Flash player", "Silverlight", "Browser", "Web browser"],
    "MOBI": ["Mobile", "Mobile phones", "Mobile phone", "Cell phone", "Mobile Phone", "J2ME", "Java ME", "Symbian OS",
             "N-Gage 2.0", "Series 40", "S40", "Bada OS", "MeeGo", "i-mode", "Yahoo Mobile", "EZweb", "Mobile Phones",
             "NTT DoCoMo", "DoCoMo", "BREW", "SoftBank"],
    "EREA": ["Nook Color"],
    ...
    "AMI": ["Amiga", "Commodore Amiga", "Commodore plus", "Commodore 16", "AmigaOS"],
